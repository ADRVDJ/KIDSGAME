 ...
 * @author Shalva
 */
public class viewCrearProfe extends javax.swing.JInternalFrame {

    /**
     * Creates new form viewCrearProfe
     */
    public viewCrearProfe() {
        initComponents();
    }
    ...
    public void setEDITAR(JPanel EDITAR) {
        this.EDITAR = EDITAR;
    }
    ...
    public void setProfesor(JLabel profesor) {
    ...
    private void initComponents() {
        ...
        EDITAR.setBackground(new java.awt.Color(153, 255, 255));
        EDITAR.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel1.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(51, 0, 0));
        jLabel1.setText("Edad:");
        EDITAR.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 240, -1, -1));

        txtnombre.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        EDITAR.add(txtnombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 80, 230, 30));

        txtapellido.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        EDITAR.add(txtapellido, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 160, 230, 30));

        txtusuario.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        EDITAR.add(txtusuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 380, 230, 30));

        txtcontraseña.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        EDITAR.add(txtcontraseña, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 450, 230, 30));

        btnRegistrar.setBackground(new java.awt.Color(255, 153, 153));
        btnRegistrar.setForeground(new java.awt.Color(0, 0, 0));
        btnRegistrar.setText("REGISTRAR");
        btnRegistrar.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        EDITAR.add(btnRegistrar, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 540, 80, 30));
        EDITAR.add(edad, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 240, -1, -1));

        jLabel7.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(51, 0, 0));
        jLabel7.setText("Contraseña:");
        EDITAR.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 450, -1, -1));

        jLabel8.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(51, 0, 0));
        jLabel8.setText("Usuario:");
        EDITAR.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 380, -1, -1));

        jLabel4.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(51, 0, 0));
        jLabel4.setText("Nombre:");
        EDITAR.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 80, -1, -1));

        jLabel5.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(51, 0, 0));
        jLabel5.setText("Apellido:");
        EDITAR.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 160, -1, -1));

        jLabel6.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(51, 0, 0));
        jLabel6.setText("Genero:");
        EDITAR.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 300, -1, -1));

        jLabel11.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jLabel11.setForeground(new java.awt.Color(0, 0, 0));
        jLabel11.setText("0");
        EDITAR.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 210, 30, -1));

        BtnEditar.setBackground(new java.awt.Color(255, 153, 153));
        BtnEditar.setForeground(new java.awt.Color(0, 0, 0));
        BtnEditar.setText("EDITAR");
        BtnEditar.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        EDITAR.add(BtnEditar, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 540, 70, 30));

        BtnEliminar.setBackground(new java.awt.Color(255, 153, 153));
        BtnEliminar.setForeground(new java.awt.Color(0, 0, 0));
        BtnEliminar.setText("ELIMINAR");
        BtnEliminar.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        EDITAR.add(BtnEliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 540, 70, 30));
        ...
        EDITAR.add(BtnLimpiar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(340, 540, 70, 30));

        profesor.setText("profesor");
        EDITAR.add(profesor, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 350, -1, -1));

        generocbm.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SELECCIONE", "MASCULINO", "FEMENINO" }));
        EDITAR.add(generocbm, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 300, 230, -1));

        getContentPane().add(EDITAR, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 60, 450, 610));
        ...
        jLabel3.setText("Crear Profesor");
        jPanel2.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 20, 190, -1));
        ...
        tablaprofe.setBackground(new java.awt.Color(255, 255, 255));
        tablaprofe.setForeground(new java.awt.Color(0, 0, 0));
