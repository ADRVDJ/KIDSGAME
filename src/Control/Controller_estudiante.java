...
import Vista.Administrador.Registro_Estudiante;
...
public class Controller_estudiante {
    ...
    public Controller_estudiante(viewCrearAdmin vista, ManagerFactory manage, UsuarioJpaController modeloUsuario, JDesktopPane panelEscritorio) {
        this.manage = manage;
...
//        persona.setPrEdad(this.vista.getEdad().getValue());
            ...
            usuario.setUsPermisos(this.vista.getEstudiante().getText());
...
//            Resouces.success("ALERTA!!", "USUARIO ELIMINADO CORECTAMENTE");
    ...
    public void limpiar() {
        ...
        this.vista.getTablaestudiante().getSelectionModel().clearSelection();
    }

    public void usuarioSeleccionado() {
        if (this.vista.getTablaestudiante().getSelectedRow() != -1) {
